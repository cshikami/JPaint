...
public class Triangle implements IShape {
	...
	public Triangle(IApplicationState applicationState, Point startPoint, Point endPoint){
	...
	public void draw(PaintCanvas paintCanvas, int startX, int startY, int width, int height) {
		...
		int xValues[] = {startX, startX+width/2, startX+width};
		int yValues[] = {startY+height, startY, startY+height};
